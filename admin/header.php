<?php
// Admin header without dark mode functionality
?>
...
<script>
// Simple header interactions without dark mode
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Admin profile dropdown interactions
  ...
  if (adminProfile && profileDropdown) {
    ...
    document.addEventListener('click', function(e) {
      if (!adminProfile.contains(e.target)) {
        // Dropdown closes automatically with CSS hover, but this handles click outside
      }
    });
  }
